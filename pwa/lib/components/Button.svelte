<script lang="ts">
  ...
  // (~/apps/nostr-pos/apps/pos-pwa/src/lib/ui/Button.svelte) — same
  // classes, same variants, same behavior.
  ...
  const classes = $derived(
    [
      ...
      variant === 'secondary' &&
        'bg-[#eadfce] text-[#2d2418] hover:bg-[#dfd1bc] dark:bg-[#2c2922] dark:text-[#fbf0df]',
