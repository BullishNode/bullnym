...
mod tests {
    ...
    fn recovery_attempt() -> ChainSwapTxAttempt {
        ...
        ChainSwapTxAttempt {
            ...
            fee_rate_sat_vb: 2.0,
            fee_decision_purpose: None,
            fee_decision_rail: None,
            fee_decision_target: None,
            fee_decision_source: None,
            fee_decision_rate_sat_vb: None,
            fee_decision_quoted_at_unix: None,
            fee_decision_evaluated_at_unix: None,
            fee_decision_freshness_age_secs: None,
            fee_decision_freshness_max_age_secs: None,
            fee_decision_provenance: None,
            fee_decision_policy_floor_sat_vb: None,
            fee_decision_policy_cap_sat_vb: None,
            fee_decision_policy_version: None,
