...
> Superseded for implementation on 2026-07-11 by
> plans/permanent-public-names-server.md and the coordinated mobile plan
> ../../bullbitcoin-mobile/plans/permanent-public-names-client.md.
>
> This file remains a research and decision-history record. Its descriptions of
> active/inactive names, alias clearing, name reactivation, and Lightning
> Address deactivation archiving web surfaces are rejected. The locked model is:
> names are claimed forever, while Lightning Address, Payment Page, and Point of
> Sale independently go online or offline.

Status: design record captured 2026-07-10 before implementation; default
nym-fallback behavior confirmed 2026-07-11.
