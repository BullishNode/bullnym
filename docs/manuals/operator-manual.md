...
This revision deliberately separates three kinds of evidence:
...
| Provider timeout after create/accept | persisted intent, provider lookup, manifest/delivery state | reconcile; do not create a second obligation blindly |
