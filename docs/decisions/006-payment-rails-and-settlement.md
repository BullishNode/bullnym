...
- Donation-page Bitcoin chain swaps send BTC to Boltz and settle LBTC to the
  page Liquid descriptor.
- Donation-page Lightning payments use Boltz and settle LBTC to the page
  Liquid descriptor.
