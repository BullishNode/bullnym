...
ADRs record accepted architectural and product contracts. They explain why a
decision exists; maintained architecture and API documentation describe its
...
primarily constrain another repository must say so explicitly and be verified
against that repository before implementation.
