...
- Status: Accepted
- Scope: `bullnym` and `bullbitcoin-mobile`
...
- linked and unlinked invoice create/list/cancel and chain-swap recovery;
- Payment Page/POS alias save and lookup compatibility;
